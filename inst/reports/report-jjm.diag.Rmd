...
author: "INSTITUTO DEL MAR DEL PERU (IMARPE)"
date: '`r Sys.Date()`'
output:
  pdf_document:
    fig_caption: yes
...
```{r echo=FALSE, fig.width = 15, fig.height = 15, fig.cap = fig$cap("object", "..."), fig.pos='h', results='hide', warning=FALSE}
#plot(object, what = "output", var = "residualsCatchAtLengthByFleet")
```
...
#plot(object, what = "output", var = "lengthFitsCatch")
```
...
pic = plot(object, what = "output", var = "predictedObservedIndices",
      ...
      main = "", xlab = list(label = "Years", cex = 1.5), ylab = list(label = "Normalized index value", cex = 1.5),
      plot = FALSE)
if(length(pic) != 1){
do.call(grid.arrange, c(pic, list(heights = c(2, 1))))  
}else{
...
```{r echo=FALSE, fig.width = 15, fig.height = 15, fig.cap = fig$cap("object", "Uncertainty of key parameters"), fig.pos='h', results='hide', warning=FALSE}
...
```{r echo=FALSE, fig.width = 15, fig.height = 15, fig.cap = fig$cap("object", "Estimated mature biomass (solid line) and the estimated inmature biomass measured in thousand tonnes"), fig.pos='h', results='hide', warning=FALSE}
...
```{r echo=FALSE, fig.width = 15, fig.height = 15, fig.cap = fig$cap("object", "Estimated total biomass (solid line) and the estimated total biomass that would have occurred if no fishing had taken place, 1970-2014"), fig.pos='h', results='hide', warning=FALSE}
